...
[**📥 下载安装（Releases）**](../../releases)　·　[快速开始](#-快速开始5-步)　·　[工具大全](#-工具大全45)　·　[从源码构建](#-从源码构建)
...
- **🧠 内置自主 Agent** —— 不是聊天框，是能连续调用 45+ 工具、自己跑完「抓包→定位→验证→补环境→实打」全流程的逆向智能体。
...
<img src="docs/wechat-group.jpg" width="360" alt="Firefox-Reverse 微信交流群二维码">
